...
export const asyncRoutes = [
  /** when your routing map is too long, you can split it into small modules **/
  {
    ...
    children: [
      ...
      {
        path: 'role-manage',
        component: () => import('@/views/admin/role-manage'),
        name: 'role-manage',
        meta: { title: '角色管理', icon: 'user', noCache: true }
      },
      {
        path: 'group-manage',
        component: () => import('@/views/admin/group-manage'),
        name: 'group-manage',
        meta: { title: '用户组管理', icon: 'user', noCache: true }
      },
      {
        path: 'power-manage',
      ...
      {
        path: 'menu-manage',
        component: () => import('@/views/admin/menu-manage'),
        name: 'menu-manage',
        meta: { title: '菜单管理', icon: 'user', noCache: true }
      },
      {
        path: 'module-manage',
        component: () => import('@/views/admin/module-manage'),
        name: 'module-manage',
        meta: { title: '模块管理', icon: 'user', noCache: true }
      },
      {
        path: 'dict-manage',
        component: () => import('@/views/admin/dict-manage'),
        name: 'dict-manage',
      ...
      },
      {
        ...
        children: [
          {
            path: 'http://localhost:9001/swagger-ui.html',
